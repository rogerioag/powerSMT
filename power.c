 ...
 */
double compute_af(counter_t num_pop_count_cycle,
...
void update_power_stats(int sn, signed long long nrCycle)
{
	...
	// fprintf(stdout,"regfile_num_pop_count_cycle: %g\n", regfile_num_pop_count_cycle[sn]);
	// fprintf(stdout,"regfile_total_pop_count_cycle: %g\n", regfile_total_pop_count_cycle[sn]);
		
	// fprintf(stdout,"resultbus_num_pop_count_cycle: %g\n", resultbus_num_pop_count_cycle[sn]);
	// fprintf(stdout,"resultbus_total_pop_count_cycle: %g\n", resultbus_total_pop_count_cycle[sn]);
...
void power_reg_stats(struct stat_sdb_t *sdb) /* stats database */
{
	...
	for (sn=0; sn<process_num; sn++) {
		...
		bzero(stat_name, sizeof(char) * 64);
		sprintf(stat_name, "alu_power_%s", itoa[sn]);
		stat_reg_double(sdb, stat_name, "total power usage of alu", &alu_power[sn], 0, NULL, sn);
		
		bzero(stat_name, sizeof(char) * 64);
		sprintf(stat_name, "falu_power_%s", itoa[sn]);
		stat_reg_double(sdb, stat_name, "total power usage of falu", &falu_power[sn], 0, NULL, sn);
		...
		stat_reg_formula(sdb, stat_name, "avg power usage of alu", formula_name, /* format */NULL, sn);
		
		bzero(stat_name, sizeof(char) * 64);
		bzero(formula_name, sizeof(char) * 512);
		sprintf(stat_name, "avg_falu_power_%s", itoa[sn]);
		sprintf(formula_name, "falu_power_%s/sim_cycle", itoa[sn]);
		stat_reg_formula(sdb, stat_name, "avg power usage of falu", formula_name, /* format */NULL, sn);
		...
		sprintf(formula_name, "(resultbus_power_%s + alu_power_%s + dcache_power_%s + dcache2_power_%s + window_power_%s + lsq_power_%s)/sim_cycle", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(rename_power_%s + bpred_power_%s + window_power_%s + lsq_power_%s + regfile_power_%s + icache_power_%s + resultbus_power_%s + clock_power_%s + alu_power_%s + dcache_power_%s + dcache2_power_%s)", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(rename_power_%s + bpred_power_%s + window_power_%s + lsq_power_%s + regfile_power_%s + icache_power_%s + resultbus_power_%s + clock_power_%s + alu_power_%s + dcache_power_%s + dcache2_power_%s)/sim_cycle", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(rename_power_%s + bpred_power_%s + window_power_%s + lsq_power_%s + regfile_power_%s + icache_power_%s + resultbus_power_%s + clock_power_%s + alu_power_%s + dcache_power_%s - falu_power_%s )/sim_cycle", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		stat_reg_formula(sdb, stat_name, "average total power per cycle", formula_name, /* format */NULL, sn);
		
		bzero(stat_name, sizeof(char) * 64);
		bzero(formula_name, sizeof(char) * 512);
		sprintf(stat_name, "avg_total_power_insn_%s", itoa[sn]);
		sprintf(formula_name, "(rename_power_%s + bpred_power_%s + window_power_%s + lsq_power_%s + regfile_power_%s + icache_power_%s + resultbus_power_%s + clock_power_%s + alu_power_%s + dcache_power_%s + dcache2_power_%s)/sim_total_insn_%s", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(rename_power_%s + bpred_power_%s + window_power_%s + lsq_power_%s + regfile_power_%s + icache_power_%s + resultbus_power_%s + clock_power_%s + alu_power_%s + dcache_power_%s - falu_power_%s )/sim_total_insn_%s", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		stat_reg_formula(sdb, stat_name, "average total power per insn", formula_name, /* format */NULL, sn);
		...
		bzero(stat_name, sizeof(char) * 64);
		sprintf(stat_name, "alu_power_cc1_%s", itoa[sn]);
		stat_reg_double(sdb, stat_name, "total power usage of alu_cc1", &alu_power_cc1[sn], 0, NULL, sn);
		...
		sprintf(formula_name, "resultbus_power_cc1_%s + alu_power_cc1_%s + dcache_power_cc1_%s + dcache2_power_cc1_%s + lsq_power_cc1_%s + window_power_cc1_%s", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(resultbus_power_cc1_%s + alu_power_cc1_%s + dcache_power_cc1_%s + dcache2_power_cc1_%s + lsq_power_cc1_%s + window_power_cc1_%s)/sim_cycle", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(rename_power_cc1_%s + bpred_power_cc1_%s + lsq_power_cc1_%s + window_power_cc1_%s + regfile_power_cc1_%s + icache_power_cc1_%s + resultbus_power_cc1_%s + clock_power_cc1_%s + alu_power_cc1_%s + dcache_power_cc1_%s +dcache2_power_cc1_%s)/sim_cycle", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(rename_power_cc1_%s + bpred_power_cc1_%s + lsq_power_cc1_%s + window_power_cc1_%s + regfile_power_cc1_%s + icache_power_cc1_%s + resultbus_power_cc1_%s + clock_power_cc1_%s + alu_power_cc1_%s + dcache_power_cc1_%s + dcache2_power_cc1_%s)/sim_total_insn_%s", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		bzero(stat_name, sizeof(char) * 64);
		sprintf(stat_name, "alu_power_cc2_%s", itoa[sn]);
		stat_reg_double(sdb, stat_name, "total power usage of alu_cc2", &alu_power_cc2[sn], 0, NULL, sn);
		...
		sprintf(formula_name, "resultbus_power_cc2_%s + alu_power_cc2_%s + dcache_power_cc2_%s + dcache2_power_cc2_%s + lsq_power_cc2_%s + window_power_cc2_%s", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(resultbus_power_cc2_%s + alu_power_cc2_%s + dcache_power_cc2_%s + dcache2_power_cc2_%s + lsq_power_cc2_%s + window_power_cc2_%s)/sim_cycle", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(rename_power_cc2_%s + bpred_power_cc2_%s + lsq_power_cc2_%s + window_power_cc2_%s + regfile_power_cc2_%s + icache_power_cc2_%s + resultbus_power_cc2_%s + clock_power_cc2_%s + alu_power_cc2_%s + dcache_power_cc2_%s + dcache2_power_cc2_%s)", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(rename_power_cc2_%s + bpred_power_cc2_%s + lsq_power_cc2_%s + window_power_cc2_%s + regfile_power_cc2_%s + icache_power_cc2_%s + resultbus_power_cc2_%s + clock_power_cc2_%s + alu_power_cc2_%s + dcache_power_cc2_%s + dcache2_power_cc2_%s)/sim_cycle", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(rename_power_cc2_%s + bpred_power_cc2_%s + lsq_power_cc2_%s + window_power_cc2_%s + regfile_power_cc2_%s + icache_power_cc2_%s + resultbus_power_cc2_%s + clock_power_cc2_%s + alu_power_cc2_%s + dcache_power_cc2_%s + dcache2_power_cc2_%s)/sim_total_insn_%s", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		bzero(stat_name, sizeof(char) * 64);
		sprintf(stat_name, "alu_power_cc3_%s", itoa[sn]);
		stat_reg_double(sdb, stat_name, "total power usage of alu_cc3", &alu_power_cc3[sn], 0, NULL, sn);
		...
		bzero(stat_name, sizeof(char) * 64);
		bzero(formula_name, sizeof(char) * 512);
		sprintf(stat_name, "avg_alu_power_cc3_%s", itoa[sn]);
		sprintf(formula_name, "alu_power_cc3_%s/sim_cycle", itoa[sn]);
		stat_reg_formula(sdb, stat_name, "avg power usage of alu_cc3", formula_name, /* format */NULL, sn);
		...
		sprintf(formula_name, "resultbus_power_cc3_%s + alu_power_cc3_%s + dcache_power_cc3_%s + dcache2_power_cc3_%s + lsq_power_cc3_%s + window_power_cc3_%s", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(resultbus_power_cc3_%s + alu_power_cc3_%s + dcache_power_cc3_%s + dcache2_power_cc3_%s + lsq_power_cc3_%s + window_power_cc3_%s)/ sim_cycle", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(rename_power_cc3_%s + bpred_power_cc3_%s + lsq_power_cc3_%s + window_power_cc3_%s + regfile_power_cc3_%s + icache_power_cc3_%s + resultbus_power_cc3_%s + clock_power_cc3_%s + alu_power_cc3_%s + dcache_power_cc3_%s + dcache2_power_cc3_%s)", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(rename_power_cc3_%s + bpred_power_cc3_%s + lsq_power_cc3_%s + window_power_cc3_%s + regfile_power_cc3_%s + icache_power_cc3_%s + resultbus_power_cc3_%s + clock_power_cc3_%s + alu_power_cc3_%s + dcache_power_cc3_%s + dcache2_power_cc3_%s)/sim_cycle", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
		...
		sprintf(formula_name, "(rename_power_cc3_%s + bpred_power_cc3_%s + lsq_power_cc3_%s + window_power_cc3_%s + regfile_power_cc3_%s + icache_power_cc3_%s + resultbus_power_cc3_%s + clock_power_cc3_%s + alu_power_cc3_%s + dcache_power_cc3_%s + dcache2_power_cc3_%s)/sim_total_insn_%s", itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn], itoa[sn]);
	...
	power_result_type *power;
{
	...
	rat_power = power->rat_decoder +power->rat_wordline+ power->rat_bitline
			+ power->rat_senseamp;
	...
	rs_power = power->rs_decoder +power->rs_wordline+ power->rs_bitline
			+ power->rs_senseamp;
	
	window_power = wakeup_power + rs_power + power->selection;
	
	lsq_rs_power = power->lsq_rs_decoder +power->lsq_rs_wordline
			+ power->lsq_rs_bitline+ power->lsq_rs_senseamp;
	
	lsq_wakeup_power = power->lsq_wakeup_tagdrive +power->lsq_wakeup_tagmatch
			+ power->lsq_wakeup_ormatch;
	
	lsq_power = lsq_wakeup_power + lsq_rs_power;
	
	reorder_power = power->reorder_decoder +power->reorder_wordline
			+ power->reorder_bitline+power->reorder_senseamp;
	
	regfile_power = power->regfile_decoder +power->regfile_wordline
...
double driver_size(	double driving_cap,
										double desiredrisetime)
{
	double nsize, psize;
	double Rpdrive;
	
	Rpdrive = desiredrisetime/(driving_cap*log(VSINV)*-1.0);
	psize = restowidth(Rpdrive, 
	PCH);
	nsize = restowidth(Rpdrive, 
	NCH);
...
double array_decoder_power(	rows,
														cols,
														predeclength,
														rports,
														wports,
	...
	int rows, cols;double predeclength;int rports, wports;int cache;
{
	...
	Ceq = (gatecap(Wdecinvn+Wdecinvp,20.0)+numstack*draincap(WdecNORn,NCH,1)
...
double simple_array_decoder_power(rows,
																	cols,
																	rports,
																	wports,
																	cache)
...
double array_wordline_power(rows,
														cols,
														wordlinelength,
														rports,
														wports,
...
double simple_array_wordline_power(	rows,
																		cols,
																		rports,
																		wports,
																		cache)
	int rows, cols;int rports, wports;int cache;
{
	...
	return (array_wordline_power(	rows,
																cols,
																wordlinelength,
																rports,
																wports,
...
double array_bitline_power(	rows,
														cols,
														bitlinelength,
														rports,
														wports,
														cache)
	int rows, cols;double bitlinelength;int rports, wports;int cache;
{
	double Ctotal=0;
	double Ccolmux=0;
	double Cbitrowr=0;
	...
	Cwritebitdrive = 2.0*(draincap(psize, 
	PCH, 1)+draincap(nsize, 
	NCH, 1));
	...
	if (cache==0)
		return (Ctotal*Powerfactor);else
		return(Ctotal*SensePowerfactor*.4);

	}

double simple_array_bitline_power(rows,
																	cols,
																	rports,
																	wports,
																	cache)
...
double compare_cap(int compare_bits)
{
	...
	c1 = (compare_bits)*(draincap(Wcompn,NCH,1)+draincap(Wcompn,NCH,2)
			+draincap(Wcomppreequ,NCH,1))+gatecap(WdecNORn,1.0)+gatecap(WdecNORp,3.0);
...
double simple_array_power(rows,
													cols,
													rports,
													wports,
													cache)
	...
	int rows, cols, rports, wports;
{
	...
	Ctotal += (rports * cols * 2* Ctlcap) +(wports * ((cols * 2* Cblcap) + (rows
			* Cwlcap)));
	
	return (Ctotal*Powerfactor*AF);
}

double cam_tagmatch(rows,
										cols,
										rports,
										wports)
	int rows, cols, rports, wports;
{
	...
	Cmlcap = 2 * cols * draincap(Wcomparen1,NCH,2) +Cmetal * matchlinelength
			+ draincap(Wmatchpchg,NCH,1) +gatecap(Wmatchinvn+Wmatchinvp,10.0)
...
double cam_array(	rows,
									cols,
									rports,
									wports)
	int rows, cols, rports, wports;
{
	return (cam_tagdrive(rows, cols, rports, wports) +cam_tagmatch(	rows,
																																	cols,
																																	rports,
																																	wports));
}
...
double selection_power(int win_entries)
{
	...
	Cpencode = draincap(WSelPn,NCH,1) + draincap(WSelPp,PCH,1) +2
			*draincap(WSelPn,NCH,1) + draincap(WSelPp,PCH,2) +3
			*draincap(WSelPn,NCH,1) + draincap(WSelPp,PCH,3) +4
			*draincap(WSelPn,NCH,1) + draincap(WSelPp,PCH,4) +4
			*gatecap(WSelEnn+WSelEnp,20.0) +4*draincap(WSelEnn,NCH,1) + 4
			*draincap(WSelEnp,PCH,1);
...
{	
	...
	power->rat_decoder
			= array_decoder_power(MD_NUM_IREGS,npreg_width,predeclength,2*ruu_decode_width,ruu_decode_width,cache);
	power->rat_wordline
			= array_wordline_power(MD_NUM_IREGS,npreg_width,wordlinelength,2*ruu_decode_width,ruu_decode_width,cache);
	power->rat_bitline
			= array_bitline_power(MD_NUM_IREGS,npreg_width,bitlinelength,2*ruu_decode_width,ruu_decode_width,cache);
	...
	predeclength = RUU_size
			* (RegCellHeight + 3 * ruu_issue_width * WordlineSpacing);
	
	wordlinelength = data_width *(RegCellWidth +
	6 * ruu_issue_width * BitlineSpacing);
	
	bitlinelength = RUU_size
			* (RegCellHeight + 3 * ruu_issue_width * WordlineSpacing);
	
	if (verbose)
		fprintf(stderr,"res station power stats\n");
	power->rs_decoder = array_decoder_power(RUU_size, data_width, predeclength, 2
			*ruu_issue_width, ruu_issue_width, cache);
	...
	bitlinelength = RUU_size
			* (RegCellHeight + 4 * res_memport * WordlineSpacing);
	
	
	/* rs's hold data */
	if (verbose)
		fprintf(stderr,"lsq station power stats\n");
	power->lsq_rs_decoder = array_decoder_power(LSQ_size,
																							data_width,
																							predeclength,
																							res_memport,
																							res_memport,
	...
	fprintf(stderr,"Calculating btb consumption parameters\n");	
	...
	predeclength = (twolev_config[0] / scale_factor)
			* (RegCellHeight + WordlineSpacing);
	wordlinelength = twolev_config[2] * scale_factor
			* (RegCellWidth + BitlineSpacing);
	bitlinelength = (twolev_config[0] / scale_factor)
			* (RegCellHeight + WordlineSpacing);
	...
	power->local_predict = array_decoder_power(	twolev_config[0]/scale_factor,
																							...
																							1,
																							cache)
			+ array_wordline_power(twolev_config[0]/scale_factor, twolev_config[2]
					*scale_factor, wordlinelength, 1, 1, cache)
			+ array_bitline_power(twolev_config[0]/scale_factor, twolev_config[2]
					*scale_factor, bitlinelength, 1, 1, cache)
			+ senseamp_power(twolev_config[2]*scale_factor);
	
	scale_factor = squarify(twolev_config[1], 3);
	
	predeclength = (twolev_config[1] / scale_factor)
			* (RegCellHeight + WordlineSpacing);
	wordlinelength = 3 * scale_factor * (RegCellWidth + BitlineSpacing);
	bitlinelength = (twolev_config[1] / scale_factor)
			* (RegCellHeight + WordlineSpacing);
	
	if (verbose)
		fprintf(stderr,"local predict power stats\n");
	power->local_predict += array_decoder_power(twolev_config[1]/scale_factor, 3
			*scale_factor, predeclength, 1, 1, cache)
			+ array_wordline_power(	twolev_config[1]/scale_factor,
															3*scale_factor,
															wordlinelength,
															1,
															1,
															cache) + array_bitline_power(twolev_config[1]
			/scale_factor, 3*scale_factor, bitlinelength, 1, 1, cache)
	...
	predeclength = bimod_config[0]/scale_factor
			* (RegCellHeight + WordlineSpacing);
	wordlinelength = 2*scale_factor * (RegCellWidth + BitlineSpacing);
	bitlinelength = bimod_config[0]/scale_factor
			* (RegCellHeight + WordlineSpacing);
	
	if (verbose)
		fprintf(stderr,"global predict power stats\n");
	power->global_predict = array_decoder_power(bimod_config[0]/scale_factor, 2
			*scale_factor, predeclength, 1, 1, cache)
			+ array_wordline_power(	bimod_config[0]/scale_factor,
															...
															1,
															1,
															cache) + array_bitline_power(bimod_config[0]
			/scale_factor, 2*scale_factor, bitlinelength, 1, 1, cache)
			+ senseamp_power(2*scale_factor);
	
	scale_factor = squarify(comb_config[0], 2);
	
	predeclength = comb_config[0]/scale_factor
			* (RegCellHeight + WordlineSpacing);
	wordlinelength = 2*scale_factor * (RegCellWidth + BitlineSpacing);
	bitlinelength = comb_config[0]/scale_factor
			* (RegCellHeight + WordlineSpacing);
	
	if (verbose)
		fprintf(stderr,"chooser predict power stats\n");
	power->chooser = array_decoder_power(comb_config[0]/scale_factor, 2
			*scale_factor, predeclength, 1, 1, cache)
			+ array_wordline_power(	comb_config[0]/scale_factor,
															...
															1,
															1,
															cache) + array_bitline_power(comb_config[0]
			/scale_factor, 2*scale_factor, bitlinelength, 1, 1, cache)
			+ senseamp_power(2*scale_factor);
	...
	tagsize = va_size - ((int)logtwo(cache_dl1->nsets)
			+ (int)logtwo(cache_dl1->bsize));
	
	if (verbose)
		fprintf(stderr,"dtlb predict power stats\n");
	power->dtlb = res_memport*(cam_array(dtlb->nsets, va_size
			- (int)logtwo((double)dtlb->bsize), 1, 1)
			+ simple_array_power(dtlb->nsets, tagsize, 1, 1, cache));
	
	tagsize = va_size - ((int)logtwo(cache_il1->nsets)
			+ (int)logtwo(cache_il1->bsize));
	
	predeclength = itlb->nsets * (RegCellHeight + WordlineSpacing);
	wordlinelength = logtwo((double)itlb->bsize)
			* (RegCellWidth + BitlineSpacing);
	bitlinelength = itlb->nsets * (RegCellHeight + WordlineSpacing);
	
	if (verbose)
		fprintf(stderr,"itlb predict power stats\n");
	power->itlb = cam_array(itlb->nsets, va_size
			- (int)logtwo((double)itlb->bsize), 1, 1)
			+ simple_array_power(itlb->nsets, tagsize, 1, 1, cache);
	
	cache=1;
	
	time_parameters.cache_size = cache_il1->nsets * cache_il1->bsize
			* cache_il1->assoc; /* C */
	...
	fprintf(stderr,"Calculating il1 consumption parameters\n");
	...
	power->icache_decoder = ndwl*ndbl*array_decoder_power(rowsb,
																												colsb,
																												predeclength,
																												1,
																												1,
																												cache);
	power->icache_wordline = ndwl*ndbl*array_wordline_power(rowsb,
																													colsb,
																													wordlinelength,
																													1,
																													1,
																													cache);
	power->icache_bitline = ndwl*ndbl*array_bitline_power(rowsb,
																												colsb,
																												bitlinelength,
																												1,
																												1,
	...
	power->icache_tagarray = ntwl*ntbl*(simple_array_power(	trowsb,
																													tcolsb,
																													1,
																													1,
																													cache));
	
	power->icache_power = power->icache_decoder + power->icache_wordline
			+ power->icache_bitline+ power->icache_senseamp+ power->icache_tagarray;
	
	time_parameters.cache_size = cache_dl1->nsets * cache_dl1->bsize
			* cache_dl1->assoc; /* C */
	...
	fprintf(stderr,"Calculating dl1 consumption parameters\n");
	...
	power->dcache_decoder = res_memport*ndwl*ndbl
			*array_decoder_power(rowsb, colsb, predeclength, 1, 1, cache);
	power->dcache_wordline = res_memport*ndwl*ndbl
			*array_wordline_power(rowsb, colsb, wordlinelength, 1, 1, cache);
	power->dcache_bitline = res_memport*ndwl*ndbl
			*array_bitline_power(rowsb, colsb, bitlinelength, 1, 1, cache);
	...
	power->dcache_power = power->dcache_decoder + power->dcache_wordline
			+ power->dcache_bitline+ power->dcache_senseamp+ power->dcache_tagarray;
	...
	time_parameters.cache_size = cache_dl2->nsets * cache_dl2->bsize
			* cache_dl2->assoc; /* C */
	...
	tagsize = va_size - ((int)logtwo(cache_dl2->nsets)
			+ (int)logtwo(cache_dl2->bsize));
	trowsb = c/(b*a*ntbl*ntspd);
	tcolsb = a * (tagsize + 1+ 6)* ntspd/ntwl;
	...
	power->dcache2_power = power->dcache2_decoder + power->dcache2_wordline
			+ power->dcache2_bitline+ power->dcache2_senseamp
			+ power->dcache2_tagarray;
	...
	power->total_power = power->local_predict + power->global_predict
			+power->chooser+ power->btb+power->rat_decoder+ power->rat_wordline
			+power->rat_bitline+ power->rat_senseamp+power->dcl_compare
			+ power->dcl_pencode+power->inst_decoder_power+power->wakeup_tagdrive
			+ power->wakeup_tagmatch+power->selection+power->regfile_decoder
			+ power->regfile_wordline+power->regfile_bitline+ power->regfile_senseamp
			+power->rs_decoder+ power->rs_wordline+power->rs_bitline
			+ power->rs_senseamp+power->lsq_wakeup_tagdrive
			+ power->lsq_wakeup_tagmatch+power->lsq_rs_decoder
			+ power->lsq_rs_wordline+power->lsq_rs_bitline+ power->lsq_rs_senseamp
			+power->resultbus+power->clock_power+power->icache_power+power->itlb
			+power->dcache_power+power->dtlb+power->dcache2_power;
	...
	power->bpred_power = power->btb + power->local_predict+ power->global_predict
			+ power->chooser+ power->ras;
	
	power->rat_power = power->rat_decoder +power->rat_wordline
			+ power->rat_bitline+ power->rat_senseamp;
	
	power->dcl_power = power->dcl_compare + power->dcl_pencode;
	
	power->rename_power = power->rat_power +power->dcl_power
			+power->inst_decoder_power;
	
	power->wakeup_power = power->wakeup_tagdrive + power->wakeup_tagmatch
			+power->wakeup_ormatch;
	
	power->rs_power = power->rs_decoder +power->rs_wordline+ power->rs_bitline
			+ power->rs_senseamp;
	
	power->rs_power_nobit = power->rs_decoder +power->rs_wordline
			+ power->rs_senseamp;
	
	power->window_power = power->wakeup_power + power->rs_power+power->selection;
	
	power->lsq_rs_power = power->lsq_rs_decoder +power->lsq_rs_wordline
			+ power->lsq_rs_bitline+power->lsq_rs_senseamp;
	
	power->lsq_rs_power_nobit = power->lsq_rs_decoder +power->lsq_rs_wordline
			+ power->lsq_rs_senseamp;
	
	power->lsq_wakeup_power = power->lsq_wakeup_tagdrive
			+ power->lsq_wakeup_tagmatch;
	
	power->lsq_power = power->lsq_wakeup_power + power->lsq_rs_power;
	
	power->regfile_power = power->regfile_decoder +power->regfile_wordline
			+ power->regfile_bitline+power->regfile_senseamp;
	
	power->regfile_power_nobit = power->regfile_decoder + power->regfile_wordline + power->regfile_senseamp;
	
	fprintf(stderr,"Call dump_power_stats:\n");
