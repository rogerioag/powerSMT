...
if (!mystricmp(TECH_FACTOR, "TECH_800")){
	/* scaling factors */
...
else if (!mystricmp(TECH_FACTOR, "TECH_400")){
	CSCALE =			1.0;			/* wire capacitance scaling factor */
	RSCALE =			1.0;			/* wire resistance scaling factor */
...
else if (!mystricmp(TECH_FACTOR, "TECH_350")){
...
else if (!mystricmp(TECH_FACTOR, "TECH_250"))
{
...
else if (!mystricmp(TECH_FACTOR, "TECH_180"))
{
...
/* HotLeakage */    
/* HotLeakage  options */
 opt_reg_string(odb, "-technology", "technology length (nm) i.e., {TECH_800, TECH_400, TECH_350, TECH_250, TECH_180, TECH_130, TECH_100, TECH_070, |none}", &TECH_FACTOR, "TECH_070",/* print */TRUE, NULL, 0);
}


void power_check_options(struct opt_odb_t *odb, int argc, char **argv)
{
	if(mystricmp(TECH_FACTOR, "TECH_800") && 
	   mystricmp(TECH_FACTOR, "TECH_400") &&
	   mystricmp(TECH_FACTOR, "TECH_350") &&
	   mystricmp(TECH_FACTOR, "TECH_250") &&
	   mystricmp(TECH_FACTOR, "TECH_180") &&
	   mystricmp(TECH_FACTOR, "TECH_130") &&
	   mystricmp(TECH_FACTOR, "TECH_100") &&
	   mystricmp(TECH_FACTOR, "TECH_070") &&
	   mystricmp(TECH_FACTOR, "")){
		fatal(0, "Invalid technology length parameter");
	}
}
