  		    	...
  		    	do
  		    		...
  		    		il1_nBanks=$[$numProcessos / $iModulo]
  		      		...
  		      		CACHE_IL1="-cache:il1 il1:${il1_nBanks}:${cacheSize}:${blockSize}:${assoc}:${repl}"
			  		    ...
			  		    NOME_ARQUIVO="${OUTPUT_DIR}/proc_${numProcessos}__mod_${iModulo}__nbank_${il1_nBanks}__benchs_${iBenchmark}_${fIndex}__csize_${cacheSize}__bsize_${blockSize}__assoc_${assoc}__repl_${repl}_sim.out"
