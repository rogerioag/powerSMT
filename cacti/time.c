...
/*----------------------------------------------------------------------*/
void dumpVarsValuesCACTI(){
		printf("Dump Variables and values in CACTI 4.0 Scope:\n");
		printf("ADDRESS_BITS: %d\n",ADDRESS_BITS);
		printf("BITOUT: %d\n",BITOUT);
		// printf("MAXN: %d\n",MAXN); 
		printf("MAXSUBARRAYS: %d\n",MAXSUBARRAYS);
		// printf("MAXSPD: %d\n", MAXSPD);
		printf("FUDGEFACTOR: %g\n",FUDGEFACTOR);
		// fprintf(stderr,"TECH_LENGTH: %g\n", TECH_LENGTH);
		// printf("GEN_POWER_FACTOR: %g\n", GEN_POWER_FACTOR);
		// printf("CSCALE: %g\n",CSCALE);
		// printf("RSCALE: %g\n",RSCALE);
		// printf("LSCALE: %g\n",LSCALE);
		// printf("ASCALE: %g\n",ASCALE);
		...
		printf("Cndiffovlp: %g\n",Cndiffovlp);
		printf("Cpdiffovlp: %g\n",Cpdiffovlp);
		printf("Cnoxideovlp: %g\n",Cnoxideovlp);
		printf("Cpoxideovlp: %g\n",Cpoxideovlp);
		printf("Leff: %g\n",Leff);
		printf("Cgate: %g\n",Cgate);
		printf("Cgatepass: %g\n",Cgatepass);
		printf("Cpolywire: %g\n",Cpolywire);
		printf("Rnchannelstatic: %g\n",Rnchannelstatic);
		printf("Rpchannelstatic: %g\n",Rpchannelstatic);
		printf("Rnchannelon: %g\n",Rnchannelon);
		printf("Rpchannelon: %g\n",Rpchannelon);
		printf("Rbitmetal: %g\n",Rbitmetal);
		printf("Rwordmetal: %g\n",Rwordmetal);
		printf("Vdd: %g\n",Vdd);
		// printf("Mhz: %g\n", Mhz);
		...
		//printf("SensePowerfactor3: %g\n",SensePowerfactor3);
		//printf("SensePowerfactor2: %g\n",SensePowerfactor2);
		//printf("SensePowerfactor: %g\n",SensePowerfactor);
		//printf("AF: %g\n",AF);
		//printf("POPCOUNT_AF: %g\n",POPCOUNT_AF);
		printf("VSINV: %g\n",VSINV);
		printf("VTHINV100x60: %g\n",VTHINV100x60);
		printf("VTHNAND60x90: %g\n",VTHNAND60x90);
		printf("VTHNOR12x4x1: %g\n",VTHNOR12x4x1);
		printf("VTHNOR12x4x2: %g\n",VTHNOR12x4x2);
		printf("VTHNOR12x4x3: %g\n",VTHNOR12x4x3);
		printf("VTHNOR12x4x4: %g\n",VTHNOR12x4x4);
		printf("VTHOUTDRINV: %g\n",VTHOUTDRINV);
		printf("VTHOUTDRNOR: %g\n",VTHOUTDRNOR);
		printf("VTHOUTDRNAND: %g\n",VTHOUTDRNAND);
		printf("VTHOUTDRIVE: %g\n",VTHOUTDRIVE);
		printf("VTHCOMPINV: %g\n",VTHCOMPINV);
		printf("VTHMUXDRV1: %g\n",VTHMUXDRV1);
		printf("VTHMUXDRV2: %g\n",VTHMUXDRV2);
		printf("VTHMUXDRV3: %g\n",VTHMUXDRV3);
		printf("VTHEVALINV: %g\n",VTHEVALINV);
		printf("VTHSENSEEXTDRV: %g\n",VTHSENSEEXTDRV);
		printf("Wdecdrivep: %g\n",Wdecdrivep);
		printf("Wdecdriven: %g\n",Wdecdriven);
		printf("Wdec3to8n: %g\n",Wdec3to8n);
		printf("Wdec3to8p: %g\n",Wdec3to8p);
		...
		printf("Wdecinvn: %g\n",Wdecinvn);
		printf("Wdecinvp: %g\n",Wdecinvp);
		printf("Wworddrivemax: %g\n",Wworddrivemax);
		printf("Wmemcella: %g\n",Wmemcella);
		//printf("Wmemcellr: %g\n",Wmemcellr);
		//printf("Wmemcellw: %g\n",Wmemcellw);
		printf("Wmemcellbscale: %g\n",Wmemcellbscale);
		printf("Wbitpreequ: %g\n",Wbitpreequ);
		// printf("Wbitmuxn: %g\n",Wbitmuxn);
		// printf("WsenseQ1to4: %g\n",WsenseQ1to4);
		printf("Wcompinvp1: %g\n",Wcompinvp1);
		printf("Wcompinvn1: %g\n",Wcompinvn1);
		printf("Wcompinvp2: %g\n",Wcompinvp2);
		printf("Wcompinvn2: %g\n",Wcompinvn2);
		...
		printf("Wcompn: %g\n",Wcompn);
		printf("Wcompp: %g\n",Wcompp);
		//printf("Wcomppreequ: %g\n",Wcomppreequ);
		printf("Wmuxdrv12n: %g\n",Wmuxdrv12n);
		printf("Wmuxdrv12p: %g\n",Wmuxdrv12p);
		printf("WmuxdrvNANDn: %g\n",WmuxdrvNANDn);
		printf("WmuxdrvNANDp: %g\n",WmuxdrvNANDp);
		printf("WmuxdrvNORn: %g\n",WmuxdrvNORn);
		printf("WmuxdrvNORp: %g\n",WmuxdrvNORp);
		printf("Wmuxdrv3n: %g\n",Wmuxdrv3n);
		printf("Wmuxdrv3p: %g\n",Wmuxdrv3p);
		printf("Woutdrvseln: %g\n",Woutdrvseln);
		printf("Woutdrvselp: %g\n",Woutdrvselp);
		printf("Woutdrvnandn: %g\n",Woutdrvnandn);
		printf("Woutdrvnandp: %g\n",Woutdrvnandp);
		printf("Woutdrvnorn: %g\n",Woutdrvnorn);
		printf("Woutdrvnorp: %g\n",Woutdrvnorp);
		printf("Woutdrivern: %g\n",Woutdrivern);
		printf("Woutdriverp: %g\n",Woutdriverp);
		//printf("Wcompcellpd2: %g\n",Wcompcellpd2);
		//printf("Wcompdrivern: %g\n",Wcompdrivern);
		//printf("Wcompdriverp: %g\n",Wcompdriverp);
		//printf("Wcomparen2: %g\n",Wcomparen2);
		//printf("Wcomparen1: %g\n",Wcomparen1);
		//printf("Wmatchpchg: %g\n",Wmatchpchg);
		//printf("Wmatchinvn: %g\n",Wmatchinvn);
		//printf("Wmatchinvp: %g\n",Wmatchinvp);
		//printf("Wmatchnandn: %g\n",Wmatchnandn);
		//printf("Wmatchnandp: %g\n",Wmatchnandp);
		//printf("Wmatchnorn: %g\n",Wmatchnorn);
		//printf("Wmatchnorp: %g\n",Wmatchnorp);
		//printf("WSelORn: %g\n",WSelORn);
		//printf("WSelORprequ: %g\n",WSelORprequ);
		//printf("WSelPn: %g\n",WSelPn);
		//printf("WSelPp: %g\n",WSelPp);
		//printf("WSelEnn: %g\n",WSelEnn);
		//printf("WSelEnp: %g\n",WSelEnp);
		printf("Wsenseextdrv1p: %g\n",Wsenseextdrv1p);
		printf("Wsenseextdrv1n: %g\n",Wsenseextdrv1n);
		printf("Wsenseextdrv2p: %g\n",Wsenseextdrv2p);
		printf("Wsenseextdrv2n: %g\n",Wsenseextdrv2n);
		printf("BitWidth: %g\n",BitWidth);
		printf("BitHeight: %g\n",BitHeight);
		printf("Cout: %g\n",Cout);
		//printf("RatCellHeight: %g\n",RatCellHeight);
		//printf("RatCellWidth: %g\n",RatCellWidth);
		//printf("RatShiftRegWidth: %g\n",RatShiftRegWidth);
		//printf("RatNumShift: %g\n",RatNumShift);
		//printf("BitlineSpacing: %g\n",BitlineSpacing);
		//printf("WordlineSpacing: %g\n",WordlineSpacing);
		//printf("RegCellHeight: %g\n",RegCellHeight);
		//printf("RegCellWidth: %g\n",RegCellWidth);
		//printf("CamCellHeight: %g\n",CamCellHeight);
		//printf("CamCellWidth: %g\n",CamCellWidth);
		//printf("MatchlineSpacing: %g\n",MatchlineSpacing);
		//printf("TaglineSpacing: %g\n",TaglineSpacing);
